...
while running:
    ...
    for event in pygame.event.get():
        ...
        # Create a new enemy
            ...
            # Create and add to sprite groups
            new_enemy = Enemy()
    ...
    #Get the set of keys pressed anc check for input
    ...
    # Ensure program maintains frame rate
    clock.tick(60)
